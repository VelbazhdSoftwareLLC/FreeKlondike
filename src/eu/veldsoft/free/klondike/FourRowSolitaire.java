 ...
 * Class: FreeKlondike
 * 
 * Description: The FreeKlondike class adds a menu to the SolitaireBoard
 * Frame.
 * 
 * @author Matt Stephen
 */
public class FreeKlondike extends SolitaireBoardFrame implements
		ActionListener {
	...
	private void checkForUpdate() {
		...
		try {
			URL url = new URL(
					"http://www.mastadisasta.com/FreeKlondike/version.txt");
	...
	public static void main(String[] args) {
		...
		FreeKlondike FreeKlondike = new FreeKlondike();
	}
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == newGame) {
			...
			JOptionPane
					.showMessageDialog(
							this,
							"Free Klondike was created by Matt Stephen and\n"
									...
									+ "github.com/TodorBalabanov/FreeKlondike",
							"About Game", JOptionPane.INFORMATION_MESSAGE);
		} else if (e.getSource() == checkUpdate) {
			try {
				Desktop.getDesktop()
						.browse(new URI(
								"http://github.com/TodorBalabanov/FreeKlondike/"));
			} catch (Exception ex) {
				System.out.println(ex);
			}
		}
